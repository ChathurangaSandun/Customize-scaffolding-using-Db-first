...
{
    public class MyEntityTypeWriter : Microsoft.EntityFrameworkCore.Scaffolding.Internal.CSharpEntityTypeGenerator
    {
        ...
        private void GenerateClass(IEntityType entityType)
        {
            ...
            _sb.AppendLine($"public partial class {entityType.Name} : BaseClass");
